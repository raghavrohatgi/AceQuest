...
source_pdf: "CBSE Books Science/Class 7/Chapter 7 - Heat Transfer in Nature.pdf"
...
$\diamond$  Attach four pins to the strip with the help of wax such that they are arranged at nearly equal distances (about 2 cm apart), as shown in Fig. 7.1.
$\diamond$  Secure the strip to a stand and label the pins as I, II, III, and IV, as shown in Fig. 7.1. (If a stand is not available, place the strip between two bricks for support.)
...
$\diamond$  Record your observations in Table 7.1.
...
(Fig. 7.7a). Hence, in hot places, sea breeze relieves people from the heat. That is why, windows of the houses in coastal areas are placed facing the sea.
