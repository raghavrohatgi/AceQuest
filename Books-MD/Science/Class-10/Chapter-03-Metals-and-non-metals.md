...
source_pdf: "CBSE Books Science/Class 10/Chapter 3 - Metals and non-metals.pdf"
...
\text{(Copper)} \quad \text{(Copper(II) oxide)}
\end{array}
$$
...
\text{(Aluminium)} \quad \text{(Aluminium oxide)}
\end{array}
$$
...
$\mathrm{Ca(s)} + 2\mathrm{H}_{2}\mathrm{O(l)}\rightarrow \mathrm{Ca(OH)}_{2}(\mathrm{aq}) + \mathrm{H}_{2}(\mathrm{g})$
...
$3\mathrm{Fe}(\mathrm{s}) + 4\mathrm{H}_{2}\mathrm{O}(\mathrm{g}) \rightarrow \mathrm{Fe}_{2}\mathrm{O}_{4}(\mathrm{s}) + 4\mathrm{H}_{2}(\mathrm{g})$
...
Hydrogen gas is not evolved when a metal reacts with nitric acid. It is because $\mathrm{HNO}_3$ is a strong oxidising agent. It oxidises the $\mathrm{H}_2$ produced to water and itself gets reduced to any of the nitrogen oxides ($\mathrm{N}_2\mathrm{O}, \mathrm{NO}, \mathrm{NO}_3$). But magnesium (Mg) and manganese (Mn) react with very dilute $\mathrm{HNO}_3$ to evolve $\mathrm{H}_2$ gas.
...
4. Which gas is produced when dilute hydrochloric acid is added to a reactive metal? Write the chemical reaction when iron reacts with dilute $\mathrm{H}_2\mathrm{SO}_4$.
...
and it requires one more electron to complete its octet. If sodium and chlorine were to react, the electron lost by sodium could be taken up by chlorine. After gaining an electron, the chlorine atom gets a unit negative charge, because its nucleus has 17 protons and there are 18 electrons in its K, L and M shells. This gives us a chloride anion  $\mathrm{C}1^{-}$ . So both these elements can have a give-and-take relation between them as follows (Fig. 3.5).
...
2,8,2 \quad 2,8 \\
\text{(Magnesium cation)} \\
\mathrm{Cl} \quad + \mathrm{e}^{-} \quad \longrightarrow \quad \mathrm{Cl}^{-} \\
2,8,7 \quad 2,8,8 \\
\text{(Chloride anion)} \\
\mathrm{Mg} \rightleftharpoons + \begin{array}{c} \mathrm{X} \\ \mathrm{Cl} \\ \mathrm{Cl} \\ \mathrm{Cl}^{-} \end{array} \longrightarrow \mathrm{Mg}^{2+} \quad \longrightarrow \quad \mathrm{Mg}^{3+} \quad \longrightarrow \quad \mathrm{Mg}^{4+} \quad \longrightarrow \quad \mathrm{Mg}^{5+} \quad \longrightarrow \quad \mathrm{Mg}^{6+} \quad \longrightarrow \quad \mathrm{Mg}^{7+} \quad \longrightarrow \quad \mathrm{Mg}^{8+} \quad \longrightarrow \quad \mathrm{Mg}^{9+} \\
\end{array}
$$

Figure 3.6 Formation of magnesium chloride

The compounds formed in this manner by the transfer of electrons from a metal to a non-metal are known as ionic compounds or electrovalent compounds. Can you name the cation and anion present in $\mathrm{MgCl}_2$?
...
$$
2 \mathrm{Cu}_2\mathrm{S} + 3 \mathrm{O}_2(\mathrm{g}) \xrightarrow{\text{Heat}} 2 \mathrm{Cu}_2\mathrm{O}(\mathrm{s}) + 2 \mathrm{SO}_2(\mathrm{g})
$$

$$
2 \mathrm{Cu}_2\mathrm{O} + \mathrm{Cu}_2\mathrm{S} \xrightarrow{\text{Heat}} 6 \mathrm{Cu}(\mathrm{s}) + \mathrm{SO}_2(\mathrm{g})
$$
...
$$
\mathrm{ZnCO}_2(\mathrm{s}) \xrightarrow{\text{Heat}} \mathrm{ZnO}(\mathrm{s}) + \mathrm{CO}_2(\mathrm{g})
$$
...
$$
3 \mathrm{MnO}_2(\mathrm{s}) + 4 \mathrm{Al}(\mathrm{s}) \rightarrow 3 \mathrm{Mn}(\mathrm{l}) + 2 \mathrm{Al}_2\mathrm{O}_3(\mathrm{s}) + \text{Heat}
$$
...
At anode $2\mathrm{Cl}^{-} \rightarrow \mathrm{Cl}_2 + 2\mathrm{e}^{-}$
...
(b) $\mathrm{MgCl}_2$ solution and aluminium metal
(c) $\mathrm{FeSO}_4$ solution and silver metal
(d) $\mathrm{AgNO}_3$ solution and copper metal.
