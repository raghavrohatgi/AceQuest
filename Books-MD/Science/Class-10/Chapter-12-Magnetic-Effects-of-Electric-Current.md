...
source_pdf: "CBSE Books Science/Class 10/Chapter 12 - Magnetic Effects of Electric Current.pdf"
...
- Take a small aluminium rod AB (of about  $5\mathrm{cm}$ ). Using two connecting wires suspend it horizontally from a stand, as shown in Fig. 12.12.
...
- In our houses we receive AC electric power of $220\mathrm{V}$ with a frequency of $50\mathrm{Hz}$. One of the wires in this supply is with red insulation, called live wire. The other one is of black insulation, which is a neutral wire. The potential difference between the two is $220\mathrm{V}$. The third is the earth wire that has green insulation and this is connected to a metallic body deep inside earth. It is used as a safety measure to ensure that any leakage of current to a metallic body does not give any severe shock to a user.
