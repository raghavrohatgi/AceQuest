...
source_pdf: "CBSE Books Science/Class 10/Chapter 5 - Life Processes.pdf"
...
$$
6 \mathrm{CO}_{2} + 12 \mathrm{H}_{2} \mathrm{O} \xrightarrow{\text{Chlorophyll}} \mathrm{C}_{6} \mathrm{H}_{12} \mathrm{O}_{6} + 6 \mathrm{O}_{2} + 6 \mathrm{H}_{2} \mathrm{O}
$$
...
- Take a potted plant with variegated leaves – for example, money plant or protons.
...
$$
\mathrm {A D P} + \text {P} \xrightarrow {\text {E n e r g y}} \mathrm {A D P} - \text {P} = \mathrm {A T P}
$$

P: Phosphate

Endothermic processes in the cell then use this ATP to drive the reactions. When the terminal phosphate linkage in ATP is broken using water, the energy equivalent to  $30.5\mathrm{kJ / mol}$  is released.
...
- If the alveolar surface were spread out, it would cover about 80 m². How much do you think the surface area of your body is? Consider how efficient exchange of gases becomes because of the large surface available for the exchange to take place.
