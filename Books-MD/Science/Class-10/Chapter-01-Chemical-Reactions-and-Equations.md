...
source_pdf: "CBSE Books Science/Class 10/Chapter 1 - Chemical Reactions and Equations.pdf"
...
$$
\text{Magnesium} + \text{Oxygen} \rightarrow \text{Magnesium oxide} \tag{1.1}
$$
...
$$
\mathrm{Mg} + \mathrm{O}_2 \rightarrow \mathrm{MgO} \tag{1.2}
$$
...
$$
\mathrm{Zinc} + \text{Sulphuric acid} \rightarrow \mathrm{Zinc\ sulphate} + \text{Hydrogen}
$$

The above word-equation may be represented by the following chemical equation -

$$
\mathrm{Zn} + \mathrm{H}_2\mathrm{SO}_4 \rightarrow \mathrm{ZnSO}_4 + \mathrm{H}_2 \tag{1.3}
$$
...
$$
\mathrm{Fe} + \mathrm{H}_2\mathrm{O} \rightarrow \mathrm{Fe}_3\mathrm{O}_4 + \mathrm{H}_2 \tag{1.4}
$$
...
$$
\mathrm{Fe} + \mathrm{H_2O} \rightarrow \mathrm{Fe_3O_4} + \mathrm{H_2} \tag{1.5}
$$
...
Step III: It is often convenient to start balancing with the compound that contains the maximum number of atoms. It may be a reactant or a product. In that compound, select the element which has the maximum number of atoms. Using these criteria, we select $\mathrm{Fe_3O_4}$ and the element oxygen in it. There are four oxygen atoms on the RHS and only one on the LHS.
...
To equalise the number of atoms, it must be remembered that we cannot alter the formulae of the compounds or elements involved in the reactions. For example, to balance oxygen atoms we can put coefficient '4' as $4\mathrm{H_2O}$ and not $\mathrm{H_2O_4}$ or $(\mathrm{H_2O})_4$. Now the partly balanced equation becomes -

$$
\mathrm{Fe} + 4 \mathrm{H_2O} \rightarrow \mathrm{Fe_3O_4} + \mathrm{H_2} \tag{1.6}
$$
...
$$
\mathrm{Fe} + 4 \mathrm{H_2O} \rightarrow \mathrm{Fe_3O_4} + 4 \mathrm{H_2} \tag{1.7}
$$
...
$$
3 \mathrm{Fe} + 4 \mathrm{H_2O} \rightarrow \mathrm{Fe_3O_4} + 4 \mathrm{H_2} \tag{1.8}
$$
...
$$
3 \mathrm{Fe} + 4 \mathrm{H_2O} \rightarrow \mathrm{Fe_3O_4} + 4 \mathrm{H_2} \tag{1.9}
$$
...
$$
3 \mathrm{Fe(s)} + 4 \mathrm{H_2O(g)} \rightarrow \mathrm{Fe_3O_4(s)} + 4 \mathrm{H_2(g)} \tag{1.10}
$$

Note that the symbol (g) is used with $\mathrm{H_2O}$ to indicate that in this reaction water is used in the form of steam.
...
$$
6 \mathrm{CO_2(aq)} + 12 \mathrm{H_2O(l)} \xrightarrow[\text{Chlorophyll}]{\text{Sunlight}} \mathrm{C_6H_{12}O_6(aq)} + 6 \mathrm{O_2(aq)} + 6 \mathrm{H_2O(l)} \tag{1.12}
$$
...
$$
\begin{array}{c c c c c} \mathrm {C a O (s)} &amp; + &amp; \mathrm {H} _ {2} \mathrm {O (l)} &amp; \rightarrow \mathrm {C a (O H)} _ {3} (\mathrm {a q}) &amp; + &amp; \mathrm {H e a t} \\ (\text {Q u i c k l i m e}) &amp; &amp; &amp; (\text {S l a k e d l i m e}) &amp; &amp; \end{array} \tag {1.13}
$$
...
$$
\begin{array}{c c c c}
\mathrm{Ca(OH)}_2(\mathrm{aq}) + \mathrm{CO}_3(\mathrm{g}) &amp; \rightarrow &amp; \mathrm{CaCO}_3(\mathrm{s}) &amp; + \mathrm{H}_2\mathrm{O}(\mathrm{l}) \\
(\text{Calcium} &amp; &amp; (\text{Calcium} \\
\text{hydroxide})} &amp; &amp; \text{carbonate})
\end{array}
\tag{1.14}
$$
...
(ii) Formation of water from $\mathrm{H}_2(\mathrm{g})$ and $\mathrm{O}_2(\mathrm{g})$
...
$$
2 \mathrm{FeSO}_{4}(\mathrm{s}) \xrightarrow{\text{Heat}} \mathrm{Fe}_{2} \mathrm{O}_{3}(\mathrm{s}) + \mathrm{SO}_{2}(\mathrm{g}) + \mathrm{SO}_{3}(\mathrm{g}) \tag{1.19}
$$
...
$$
\mathrm{CaCO}_{3}(\mathrm{s}) \xrightarrow{\text{Heat}} \mathrm{CaO}(\mathrm{s}) + \mathrm{CO}_{2}(\mathrm{g}) \tag{1.20}
$$
...
You will observe the emission of brown fumes. These fumes are of nitrogen dioxide (NO₂). The reaction that takes place is –

$$
2 \mathrm{Pb}(\mathrm{NO}_{3})_{2}(\mathrm{s}) \xrightarrow{\text{Heat}} 2 \mathrm{PbO}(\mathrm{s}) + 4 \mathrm{NO}_{2}(\mathrm{g}) + \mathrm{O}_{2}(\mathrm{g}) \tag{1.21}
$$
...
$$
2 \mathrm{AgCl}(\mathrm{s}) \xrightarrow{\text{Sunlight}} 2 \mathrm{Ag}(\mathrm{s}) + \mathrm{Cl}_{2}(\mathrm{g}) \tag{1.22}
$$
...
$$
2 \mathrm {A g B r} (\mathrm {s}) \xrightarrow {\text {S u n l i g h t}} 2 \mathrm {A g} (\mathrm {s}) + \mathrm {B r} _ {2} (\mathrm {g}) \tag {1.23}
$$
...
$$
\mathrm{Fe}(\mathrm{s}) + \mathrm{CuSO}_{4}(\mathrm{aq}) \rightarrow \quad \mathrm{FeSO}_{4}(\mathrm{aq}) + \mathrm{Cu}(\mathrm{s}) \tag{1.24}
$$
...
$$
\mathrm{Zn}(\mathrm{s}) + \mathrm{CuSO}_{4}(\mathrm{aq}) \rightarrow \quad \mathrm{ZnSO}_{4}(\mathrm{aq}) + \mathrm{Cu}(\mathrm{s}) \tag{1.25}
$$

(Copper sulphate) (Zinc sulphate)

$$
\mathrm{Pb}(\mathrm{s}) + \mathrm{CuCl}_{2}(\mathrm{aq}) \rightarrow \quad \mathrm{PbCl}_{2}(\mathrm{aq}) + \mathrm{Cu}(\mathrm{s}) \tag{1.26}
$$
...
$$
\mathrm{Na}_{2}\mathrm{SO}_{4}(\mathrm{aq}) + \mathrm{BaCl}_{2}(\mathrm{aq}) \rightarrow \mathrm{BaSO}_{4}(\mathrm{s}) + 2\mathrm{NaCl}(\mathrm{aq}) \tag{1.27}
$$
...
What causes this? The white precipitate of $\mathrm{BaSO}_4$ is formed by the reaction of $\mathrm{SO}_4^{2-}$ and $\mathrm{Ba}^{2+}$. The other product formed is sodium chloride which remains in the solution. Such reactions in which there is an exchange of ions between the reactants are called double displacement reactions.
...
- Heat a china dish containing about $1\mathrm{g}$ copper powder (Fig. 1.10).
- What do you observe?
...
$$
2 \mathrm{Cu} + \mathrm{O}_2 \xrightarrow{\text{Heat}} 2 \mathrm{CuO} \tag{1.28}
$$
...
$$
\mathrm{CuO} + \mathrm{H}_2 \xrightarrow{\text{Heat}} \mathrm{Cu} + \mathrm{H}_2\mathrm{O} \tag{1.29}
$$
...
$$
\mathrm{ZnO} + \mathrm{C} \rightarrow \mathrm{Zn} + \mathrm{CO} \tag{1.31}
$$

$$
\mathrm{MnO}_2 + 4\mathrm{HCl} \rightarrow \mathrm{MnCl}_2 + 2\mathrm{H}_2\mathrm{O} + \mathrm{Cl}_2 \tag{1.32}
$$
...
In reaction (1.31) carbon is oxidised to CO and ZnO is reduced to Zn. In reaction (1.32) HCl is oxidised to $\mathrm{Cl}_2$ whereas $\mathrm{MnO}_2$ is reduced to $\mathrm{MnCl}_2$.
