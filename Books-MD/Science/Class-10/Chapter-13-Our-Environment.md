...
source_pdf: "CBSE Books Science/Class 10/chapter 13 - Our Environment.pdf"
...
Ozone at the higher levels of the atmosphere is a product of UV radiation acting on oxygen (O₂) molecule. The higher energy UV radiations split apart some molecular oxygen (O₂) into free oxygen (O) atoms. These atoms then combine with the molecular oxygen to form ozone as shown—

$$
\mathrm{O}_3 \xrightarrow{\mathrm{UV}} \mathrm{O} + \mathrm{O}
$$
