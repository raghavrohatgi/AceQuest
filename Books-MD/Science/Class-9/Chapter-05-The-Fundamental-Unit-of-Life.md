...
source_pdf: "CBSE Books Science/Class 9/Chapter 5 - The Fundamental Unit of Life.pdf"
...
Something similar to this happens in cells when, for example, some substance like $\mathrm{CO}_{2}$ (which is cellular waste and requires to be excreted out by the cell) accumulates in high concentrations inside the cell. In the cell's external environment, the concentration of $\mathrm{CO}_{2}$ is low as compared to that inside the cell. As soon as there is a difference of concentration of $\mathrm{CO}_{2}$ inside and outside a cell, $\mathrm{CO}_{2}$ moves out of the cell, from a region of high concentration, to a region of low concentration outside the cell by the process of diffusion. Similarly, $\mathrm{O}_{2}$ enters the cell by the process of diffusion when the level or concentration of $\mathrm{O}_{2}$ inside the cell decreases. Thus, diffusion plays an important role in gaseous exchange between the cells as well as the cell and its external environment.
...
1. How do substances like $\mathrm{CO}_{2}$ and water move in and out of the cell? Discuss.
...
|  2. Nuclear region: and known as_ | 2. Nuclear region: well defined and surrounded by a nuclear membrane  |
