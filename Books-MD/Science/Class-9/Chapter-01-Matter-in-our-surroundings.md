...
source_pdf: "CBSE Books Science/Class 9/Chapter 1 - Matter in our surroundings .pdf"
...
Have you heard of solid carbon dioxide $(\mathrm{CO}_{2})$? It is stored under high pressure. Solid $\mathrm{CO}_{2}$ gets converted directly into gaseous state on decrease of pressure to 1 atmosphere* without coming into liquid state. This is the reason that solid carbon dioxide is also known as dry ice.
...
7. Why is ice at $273\mathrm{K}$ more effective in cooling than water at the same temperature?
