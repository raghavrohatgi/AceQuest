...
grade: 9
chapter_number: 4
chapter_title: "Structures of the Atom"
source_pdf: "CBSE Books Science/Class 9/Chapter 4 - Structures of the Atom.pdf"
...
-  $\alpha$ -particles are doubly-charged helium ions. Since they have a mass of  $4\mathrm{u}$ , the fast-moving  $\alpha$ -particles have a considerable amount of energy.
...
Fig. 4.2: Scattering of  $\alpha$ -particles by a gold foil
...
formula $2n^2$, where 'n' is the orbit number or energy level index, 1,2,3,... Hence the maximum number of electrons in different shells are as follows:

first orbit or K-shell will be $= 2 \times 1^2 = 2$, second orbit or L-shell will be $= 2 \times 2^2 = 8$, third orbit or M-shell will be $= 2 \times 3^2 = 18$, fourth orbit or N-shell will be $= 2 \times 4^2 = 32$, and so on.
...
After studying the properties of the sub-atomic particles of an atom, we can conclude that mass of an atom is practically due to protons and neutrons alone. These are present in the nucleus of an atom. Hence protons and neutrons are also called nucleons. Therefore, the mass of an atom resides in its nucleus. For example, mass of carbon is $12\,\mathrm{u}$ because it has 6 protons and

6 neutrons, $6\,\mathrm{u} + 6\,\mathrm{u} = 12\,\mathrm{u}$. Similarly, the mass of aluminium is $27\,\mathrm{u}$ (13 protons+14 neutrons). The mass number is defined as the sum of the total number of protons and neutrons present in the nucleus of an atom. It is denoted by 'A'. In the notation for an atom, the atomic number, mass number and symbol of the element are to be written as:

![img-8.jpeg](img-8.jpeg)

For example, nitrogen is written as $\frac{14}{7}\mathrm{N}$.
...
In nature, a number of atoms of some elements have been identified, which have the same atomic number but different mass numbers. For example, take the case of hydrogen atom, it has three atomic species, namely protium $\left(^{1}_{1}\mathrm{H}\right)$, deuterium $\left(^{2}_{1}\mathrm{H}\right.$ or D) and tritium $\left(^{3}_{1}\mathrm{H}\right.$ or T). The atomic number of each one is 1, but the mass number is 1, 2 and 3, respectively. Other such examples are (i) carbon, $\frac{12}{6}\mathrm{C}$ and $\frac{14}{6}\mathrm{C}$, (ii) chlorine, $\frac{35}{17}\mathrm{Cl}$ and $\frac{37}{17}\mathrm{Cl}$, etc.
...
$$
\left[ \left(35 \times \frac{75}{100} + 37 \times \frac{25}{100}\right) \times \left( \frac{105}{4} + \frac{37}{4} \right) = \frac{142}{4} = 35.5 \text{ u} \right]
$$
...
10. If bromine atom is available in the form of, say, two isotopes $\frac{79}{35}\mathrm{Br}$ (49.7%) and $\frac{81}{35}\mathrm{Br}$ (50.3%), calculate the average atomic mass of bromine atom.
11. The average atomic mass of a sample of an element X is 16.2 u. What are the percentages of isotopes $\frac{16}{8}\mathrm{X}$ and $\frac{18}{8}\mathrm{X}$ in the sample?
