...
source_pdf: "CBSE Books Maths/Class 10/Chapter 04 - Quadratic Equations.pdf"
...
Now, area of the hall $= (2x + 1)$. $x \mathrm{m}^2 = (2x^2 + x) \mathrm{m}^2$
...
(i)  $\mathrm{LHS} = (x - 2)^2 + 1 = x^2 - 4x + 4 + 1 = x^2 - 4x + 5$
...
(iii) Here, $\mathrm{LHS} = x(2x + 3) = 2x^2 + 3x$
...
(iv) Here, $\mathrm{LHS} = (x + 2)^3 = x^3 + 6x^2 + 12x + 8$
...
Consider the quadratic equation $2x^{2} - 3x + 1 = 0$. If we replace $x$ by 1 on the LHS of this equation, we get $(2 \times 1^{2}) - (3 \times 1) + 1 = 0 = \mathrm{RHS}$ of the equation. We say that 1 is a root of the quadratic equation $2x^{2} - 3x + 1 = 0$. This also means that 1 is a zero of the quadratic polynomial $2x^{2} - 3x + 1$.
...
The roots of $6x^{2} - x - 2 = 0$ are the values of $x$ for which $(3x - 2)(2x + 1) = 0$. Therefore, $3x - 2 = 0$ or $2x + 1 = 0$,
...
Thus, the breadth of the hall is $12\,\mathrm{m}$. Its length $= 2x + 1 = 25\,\mathrm{m}$.
...
Now, $\mathrm{AB} = 13\mathrm{m}$, and since AB is a diameter,

$$
\angle \mathrm{APB} = 90^{\circ} \quad (\text{Why?})
$$

Therefore, $\mathrm{AP}^2 + \mathrm{PB}^2 = \mathrm{AB}^2$ (By Pythagoras theorem)
