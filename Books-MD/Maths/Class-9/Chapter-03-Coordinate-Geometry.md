...
source_pdf: "CBSE Books Maths/Class 9/Chapter 03 - Coordinate Geometry.pdf"
...
Combine both the lines in such a way that the two lines cross each other at their zeroes, or origins (Fig. 3.8). The horizontal line  $\mathrm{X}^{\prime}\mathrm{X}$  is called the  $x$ -axis and the vertical line  $\mathrm{YY}^{\prime}$  is called the  $y$ -axis. The point where  $\mathrm{X}^{\prime}\mathrm{X}$  and  $\mathrm{Y}^{\prime}\mathrm{Y}$  cross is called the origin, and is denoted by O. Since the positive numbers lie on the directions OX and OY, OX and OY are called the positive directions of the  $x$ -axis and the  $y$ -axis, respectively. Similarly,  $\mathrm{OX}^{\prime}$  and  $\mathrm{OY}^{\prime}$  are called the negative directions of the  $x$ -axis and the  $y$ -axis, respectively.
...
(i) The perpendicular distance of the point  $\mathrm{P}$  from the  $y$ -axis measured along the positive direction of the  $x$ -axis is  $\mathrm{PN} = \mathrm{OM} = 4$  units.
(ii) The perpendicular distance of the point  $\mathrm{P}$  from the  $x$ -axis measured along the positive direction of the  $y$ -axis is  $\mathrm{PM} = \mathrm{ON} = 3$  units.

Reprint 2025-26

COORDINATE GEOMETRY

(iii) The perpendicular distance of the point Q from the $y$ - axis measured along the negative direction of the $x$ - axis is $\mathrm{OR} = \mathrm{SQ} = 6$ units.
(iv) The perpendicular distance of the point Q from the $x$ - axis measured along the negative direction of the $y$ - axis is $\mathrm{OS} = \mathrm{RQ} = 2$ units.
...
Hence, the coordinates of $\mathrm{P}$ are (4, 3) and the coordinates of $\mathrm{Q}$ are $(-6, -2)$.
...
(ii) The $x$-coordinate and the $y$-coordinate of the point M are ___ and ___, respectively. Hence, the coordinates of M are (__, ___).
(iii) The $x$-coordinate and the $y$-coordinate of the point L are ___ and ___, respectively. Hence, the coordinates of L are (__, ___).
(iv) The $x$-coordinate and the $y$-coordinate of the point S are ___ and ___, respectively. Hence, the coordinates of S are (__, ___).
...
What are the coordinates of the origin  $\mathbf{O}$ ? It has zero distance from both the axes so that its abscissa and ordinate are both zero. Therefore, the coordinates of the origin are  $(\mathbf{0},\mathbf{0})$ .
